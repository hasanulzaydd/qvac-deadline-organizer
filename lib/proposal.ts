import { z } from 'zod';
import { CourseSchema, ItemSchema, NoticeSchema, RoutineSlotSchema } from './schema';
...
/** An item before saving: no id/status/createdAt yet; kind and date may be unknown. */
